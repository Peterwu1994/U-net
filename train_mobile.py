...
from Preprocessing.Preprocessing import preprocess_image_and_label_Simple, preprocess_image_and_label
from Nets.Config import Config
from losses import weighted_softmax_loss, dice_loss
slim = tf.contrib.slim

train_dir = '/raid/wuyudong/Models/DeeplabGuidewire/Mobilenet/Train/Stride32'
